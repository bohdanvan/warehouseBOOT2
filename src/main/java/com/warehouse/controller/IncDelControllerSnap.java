...
//import com.warehouse.com.warehouse.print.FileBucket;
//import com.warehouse.com.warehouse.print.MultiFileBucket;
//import com.warehouse.com.warehouse.print.UploadFile;
...
//        List<IncDel> incDelsList = incDelRepository.findAll();
//
//        double weight = 0;
//        double amount = 0;
...
//                ) {
//            weight += incDel.getWeight();
//            amount += incDel.getAmount();
//
...
//        }
//
//        modal.addObject("incDelsList", incDelsList);
//
//        modal.addObject("amount", amount);
//        modal.addObject("weight", weight);
//        modal.addObject("amountOrders", amountOrders);
//        modal.addObject("weightOrders", weightOrders);
//        modal.setViewName("admin");
//        return modal;
//    }
//
...
//    ModelAndView registred(ModelAndView model) {
//
//        try {
...
//                qty += order.getQty();
//            }
//            model.addObject("qtyProductQty", qty);
...
//        log4j.info("fileBucket add to model");
//        model.addObject("multiFileBucket", new MultiFileBucket());
//        log4j.info("multiFileBucket add to model");
//        model.addObject("uploadFile", new UploadFile());
